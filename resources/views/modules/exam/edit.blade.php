                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-7">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="title" placeholder="Exam Title" value="{{$exam->title}}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-7">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" name="description" placeholder="Exam Description" value="{{$exam->description}}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-7">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="number" name="duration" placeholder="Exam Duration" value="{{$exam->duration}}" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-7">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-7">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input class="form-control" type="datetime-local" value="{{$exam->date_time}}" name="date_time">
                                </div>
                            </div>
                        </div>
