        ...
        <div class="container-fluid">
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <h4 class="page-title">Staffs Information</h4>
                        <ol class="breadcrumb">
                        </ol>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between mb-1">
                                ...
                                <div id="ToolbarRight">
                                    @can('staff-create')
                                        <a href="{{ route('staffs.create') }}" class="btn btn-success btn-sm float-end"><i
                            ...
                            <table id="sqltable" class="table table-bordered table-striped table-hover table-sm dataTable">
                                <thead class="table-success">
                                    <tr>
                                        <th scope="col" width="4%">Staff ID</th>
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            return '@can("staff-show") <a href="staffs/' + data +
                                '" id="view_staff" class="btn btn-primary btn-sm mr-1 view_staff">View</a> @endcan' +
                                '@can("staff-edit") <a href="staffs/' + data +
                                '/edit" id="edit_staff" class="btn btn-warning btn-sm mr-1 edit_staff">Edit</a> @endcan' +
                                '@can("staff-delete") <button id="delete_staff" class="btn btn-danger btn-sm delete_staff">Delete</button> @endcan';
